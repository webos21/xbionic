...
APP := jemalloc
NDK_APPS := $(APP)
NDK_ALL_APPS := jemalloc
NDK_APP_VARS := APP_MODULES APP_PROJECT_PATH
NDK_APP.jemalloc.Application.mk := $(basedir)/apps/jemalloc/Application.mk
NDK_APP.jemalloc.APP_MODULES := jemalloc jemalloc_jet jemalloc_unittest
NDK_APP.jemalloc.APP_PROJECT_PATH := $(basedir)/apps/jemalloc/project
...
$(call __ndk_info,NDK_APP.jemalloc.Application.mk   = '$(NDK_APP.jemalloc.Application.mk)')
$(call __ndk_info,NDK_APP.jemalloc.APP_MODULES      = '$(NDK_APP.jemalloc.APP_MODULES)')
$(call __ndk_info,NDK_APP.jemalloc.APP_PROJECT_PATH = '$(NDK_APP.jemalloc.APP_PROJECT_PATH)')
